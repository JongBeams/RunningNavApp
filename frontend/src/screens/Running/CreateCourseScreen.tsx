...
import {getNaverMapDirectionsHtml, NAVER_CLIENT_ID} from '../../components/map/naverMapDirections';
import {createCourse, waypointsToGeoJson, waypointsToLineString} from '../../services/api/courseApi';
import {getRouteBetweenPoints} from '../../services/api/directionsApi';
...
export default function CreateCourseScreen() {
  ...
  const handleAddWaypoint = async (latitude: number, longitude: number) => {
    ...
    // 경유지가 2개 이상이면 Directions API로 실제 도로 경로 계산
    ...
    <View style={commonStyles.container}>
      ...
      <View style={styles.mapContainer}>
        <WebView
          ref={webViewRef}
          source={{
            html: getNaverMapDirectionsHtml(
              NAVER_CLIENT_ID,
